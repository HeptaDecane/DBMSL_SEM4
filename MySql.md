...
#### Views
>A view is a virtual table based on the result-set of an SQL statement,<br></br> The fields in a view are fields from one or more real tables in the database.
```sql
# create
